  ...
  public static void main(String[] args)
    ...
    ClassLoader loader = new ClassLoader() {
      ...
      public Class<?> loadClass(String name) throws ClassNotFoundException {
        ...
        // 不装载匿名内部类
        if (!name.equals("com.demo.java.classloader.ClassLoaderTest")) {
    ...
    Object classLoaderTest = loader
        .loadClass("com.demo.java.classloader.ClassLoaderTest").getDeclaredConstructor()
        .newInstance();

    System.out.println(classLoaderTest.getClass());

    System.out.println(classLoaderTest instanceof com.demo.java.jvm.classloader.ClassLoaderTest);
